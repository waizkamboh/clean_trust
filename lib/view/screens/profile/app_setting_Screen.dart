...
class AppSettingScreen extends StatelessWidget {
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(() => GestureDetector(
                            onTap: controller.isUpdating.value
                                ? null
                                : controller.handleLocationToggle,
                            child: appSettingContainer(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _versionRow('appSettingScreen11'.tr,
              controller.lastUpdated),
          SizedBox(height: getHeight(10)),
          _versionRow('appSettingScreen13'.tr,
  ...
  Widget _versionRow(String title, RxString value) {
    return Row(
